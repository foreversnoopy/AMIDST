...
public enum MinecraftInterfaces {
    ...
    public static Function<RecognisedVersion, MinecraftInterface> customMinecraftInterfaceFactory;
    ...
    public static MinecraftInterface fromLocalProfile(LauncherProfile launcherProfile)
        ...
        try {
            ...
            if (customMinecraftInterfaceFactory == null){
                ...
                minecraftInterface = factory.factory.apply(symbolicClassMap, recognisedVersion);
            }
            else {
                minecraftInterface = customMinecraftInterfaceFactory.apply(recognisedVersion);
            }
